                        ...
                        <Grid container className={classes.box1ContentMobile} direction={'column'} spacing={5}>
                            ...
                            <Grid item>
                                <Typography className={classes.h6Mobile} align={'center'}>
                                    ...
                                    inexploitée. Nous avons lancé l’entreprise avec un objectif précis: réduire
                                    l’empreinte
                                    écologique de chaque entraînement! Avec cet objectif en tête, notre équipe repousse
                                    les
                                    frontières de la technologie, tout en préconisant l’utilisation quotidienne
                                    d’énergies
                                    renouvelables.
                                </Typography>
                            </Grid>
                    ...
                    <Box className={classes.box2}>
                        <Grid container className={classes.box2Content} direction={'column'} spacing={8}>
                            ...
                            <Grid item container justifyContent={'center'} spacing={8}>
                                {profils.map(profil =>
                                    <Grid item container direction={'column'} xs={6} display={'flex'}
                                          justifyContent={'center'}
                                          alignItems={'center'} spacing={1}>
                                        <Grid item className={classes.profileGrid}>
